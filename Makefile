...
test: .venv ## Run tests
	$(UV) run --with typer --with packaging --with plumbum --with pyyaml --with pytest-xdist --with pytest-bdd --with pytest-rerunfailures --with syrupy --with hypothesis pytest -n auto --dist worksteal -v
